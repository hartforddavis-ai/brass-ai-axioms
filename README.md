...
Three filters governing how an AI-driven process proceeds — what it may
propose, what it may keep once built, and how much it may build at once.
Default is REJECT; a change earns its place or it doesn't ship.

- [`prime-law-1.md`](prime-law-1.md) — **Design.** Gates what may be proposed.
- [`prime-law-2.md`](prime-law-2.md) — **Build.** Gates what may be kept once built.
- [`prime-law-3.md`](prime-law-3.md) — **Concurrency.** Gates how much may be under construction at once.
